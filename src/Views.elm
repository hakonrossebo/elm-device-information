...
viewOrientationGfx model =
    let
        ...
        gammaXpos =
            toString (model.currentOrientation.gamma / 90 * 100 + 50)

        betaXpos =
            toString (model.currentOrientation.beta / 180 * 100 + 50)
    in
    ...
    let
        locationText =
            case model.location of
                ...
                Just loc ->
                    let
                        ( latitude, longitude, altitude, altitudeAccuracy ) =
                            getLocationInfo (Just loc)
                    in
